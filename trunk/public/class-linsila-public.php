...
class Linsila_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->linsila, plugin_dir_url( __FILE__ ) . 'css/linsila-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->linsila, plugin_dir_url( __FILE__ ) . 'js/linsila-public.js', array( 'jquery' ), $this->version, false );
